 ...
 */
public class UtilImgCompressor {
    private static UtilImgCompressor instance = null;
    ...
    private UtilImgCompressor(Context context) {
        this.context = context;
    }

    public static UtilImgCompressor getInstance(Context context) {
        if (instance == null) {
            synchronized (UtilImgCompressor.class) {
                if (instance == null)
                    instance = new UtilImgCompressor(context.getApplicationContext());
            }
        }
        return instance;
    }

    public UtilImgCompressor withListener(CompressListener compressListener) {
    ...
    private String getOutputFileName(String srcFilePath) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getPath(), "UtilImgCompressor/Images");
        if (!file.exists()) {
            file.mkdirs();
        }
